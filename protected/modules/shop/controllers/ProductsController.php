...
class ProductsController extends Controller
{
	...
	public function accessRules() {
		return array(
				...
				array('allow',
					'actions'=>array('admin','delete','create','update', 'view','ImageUpload','ImageGetJson'),
					'users' => array('admin'),
					),
	...
	public function beforeAction($action) {
         ...
         */
        if($action->id=='view'){
		$this->layout = Shop::module()->layout1;
        }else{
	...
	public function actionUpdate($id, $return = null)
	{
		...
		if(isset($_POST['Products']))
		{
            ...
            foreach($_POST['Products']['promo_code'] as $v){
                if($pc!=='')
                    $pc.=',';
                $pc.=$v;
            };
    ...
    {
        //$data=stripslashes(json_encode(array('image'=>'images/2daa381dc2363e7d2da4fb1a5f7647a7.jpg')));
        $data='';
        $this->layout=false;
        // $this->renderText($data);

        $this->renderPartial('_uploadimages', array(
            'data' => $data,
        ));
    }
            ...
            if (false != ($handle = opendir ( $dir ))) {
                while ( false !== ($file = readdir ( $handle )) ) {
                    ...
                    if ($file != "." && $file != ".."&&strpos($file,".")) {
                        $fileArray['thumb']=Yii::app()->baseUrl.'/images/editorimg/'.$file;
                        $fileArray['image']=Yii::app()->baseUrl.'/images/editorimg/'.$file;
                        $fileArray['title']='';
                        $fileArray['folder']='';
